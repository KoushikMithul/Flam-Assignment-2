...
if(NOT TARGET ippicv)
  ...
  set_target_properties(ippicv PROPERTIES
    ...
    IMPORTED_LOCATION "${OpenCV_INSTALL_PATH}/opencv-sdk/native/3rdparty/libs/x86/libippicv.a"
  )
endif()
...
set(__OpenCV_INCLUDE_DIRS "${OpenCV_INSTALL_PATH}/opencv-sdk/native/jni/include")
